                ...
                <form className="flex w-[80%] bg-gray-100 m-auto py-10 px-20 rounded-[15px] gap-15">
                    <div className="flex flex-col w-[400px] gap-3">
                        ...
                        <div className="w-full mt-4 flex flex-col gap-1.5 ">
                            ...
                            <div className="relative w-full bg-white flex justify-start items-center px-3 gap-2 rounded-[20px] shadow-xl"><i className="ri-mail-fill text-stone-700"></i> <input className='w-full py-2.5 outline-0' type="text" placeholder='Email' required/></div>
                        </div>
                        <div className="w-full mt-4 flex flex-col gap-1.5 ">
                            <label className='text-gray-800 text-[15px]' htmlFor="">Password</label>
                            <div className="relative w-full bg-white flex justify-start items-center px-3 gap-2 rounded-[20px] shadow-xl"><i className="ri-lock-fill text-stone-700"></i><input className='w-full py-2.5 outline-0' type="password" placeholder='Password' required/><i class="cursor-pointer ri-eye-off-fill"></i></div>
                        </div>
                        ...
                        <div className="w-full flex flex-col justify-center items-center mt-5 gap-5">
                            ...
                            <NavLink>Don't have an account? Sign up</NavLink>
                        </div>
                    </div>
