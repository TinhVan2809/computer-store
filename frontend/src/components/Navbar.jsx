...
function Navbar() {
  ...
  return (
    <>
      <header className="navbar-container w-full top-0 sticky z-100 transition bg-white shadow-2xl px-4 md:px-10">
        <div id="nav-content" className="flex justify-between md:justify-center items-center w-full py-4 md:py-5 gap-4 md:gap-10">
          ...
          {currentUser ? (
            <>
              <div className="flex justify-between items-center gap-5 cursor-pointe p-1.5 pr-4 bg-gray-100 rounded-3xl transition duration-500 shrink-0">
                {/*Searching*/}
