              ...
              {!loading && !error && users.length > 0 && (
                <>
                          ...
                          >
                            ...
                            <td className="p-3 text-center">
                              <button
                                ...
                                className="cursor-pointer px-2 py-1 bg-blue-500 text-white text-sm rounded mr-2 hover:bg-blue-600 "
                              >
                                Edit
                              </button>
                              <button
                                onClick={() => handleDeleteClick(u)}
                                className="cursor-pointer px-2 py-1 bg-red-500 text-white text-sm rounded mr-2 hover:bg-red-600"
                              >
                                Delete
                              </button>
                              
                              <button className="cursor-pointer px-2 py-1 bg-green-500 text-white text-sm rounded hover:bg-green-800 disabled:bg-gray-400" onClick={() => navigate(`/user-profile/${u.user_id}`)}>Chi tiết</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
                  ...
                  <div className="flex items-center justify-center gap-3 mt-6">
                    ...
                    <span>
                      Page {currentPage + 1} / {totalPages} (Total: {totalCount}
                      )
                    </span>
                    <button
                      className="px-3 py-1 border rounded hover:bg-gray-100 disabled:opacity-50"
